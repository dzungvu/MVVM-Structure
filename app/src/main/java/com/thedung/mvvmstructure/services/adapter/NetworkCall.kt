package com.thedung.mvvmstructure.services.adapter

import com.thedung.mvvmstructure.services.models.Error
            ...
            override fun onResponse(call: Call<SUCCESS>, response: Response<SUCCESS>) {
                ...
                if (response.isSuccessful) {
                    body?.run {
                        ...
                        callback.onResponse(
                            this@NetworkCall,
                            Response.success(NetworkResponse.UnknownError(Throwable("Empty body")))
                        )
                    }
                } else {
                    val errorBody = when {
                    ...
                    errorBody?.run {
                        ...
                        callback.onResponse(
                            this@NetworkCall,
                            Response.success(NetworkResponse.UnknownError(Throwable("Empty error body")))
                        )
                    }
                }
            }
